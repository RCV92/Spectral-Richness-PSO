SS%% Spectral Richness PSO algorithm in script
...
chi=Spectral_Richness(r,t); %Calculation of the value of spectral richness chi from the excitation signal
...
Pb=0.987;                       %Parameter $\bar{p}$ from the SR-PSO
omc=0.07;                       %Parameter $\omega_c$ from the SR-PSO
Lmin=1.65;                      %Parameter $l_{min}$ from the SR-PSO
Lb=1.2;                         %Parameter $\bar{l}$ from the SR-PSO
pc=1.2;                         %Parameter $p_c$ from the SR-PSO
...
C1=L_SR(Lb,chi,omc,Ite,K_max,Lmin); % Dynamic parameter of L based on chi
C2=P_SR(Pb,chi,omc,Ite,K_max,pc);   % Dynamic parameter of P based on chi
